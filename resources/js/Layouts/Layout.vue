...
<div class="flex"> 
    ...
    <div class="flex flex-col w-64 h-screen px-4 py-8 bg-white border-r dark:bg-gray-800 dark:border-gray-600">
        <h1 class="text-3xl font-semibold text-gray-800 dark:text-white">Stenellie Joyce Perez</h1>
        ...
        <div class="flex flex-col justify-between flex-1 mt-6">
            ...
            <div class="flex items-center px-4 -mx-2">
                <img class="object-cover mx-2 rounded-full h-9 w-9" src="https://yt3.ggpht.com/yti/ANoDKi7u_FYaPHDsRmo4D6gYQKwGcgxiY_5kUPyNNsqbMw=s88-c-k-c0x00ffffff-no-rj-mo" alt="avatar">
                <h4 class="mx-2 font-medium text-gray-800 dark:text-gray-200 hover:underline">Stenellie Joyce Perez</h4>
            </div>
        </div>
    </div>
    </div>
    ...
    <nav class="bg-white shadow dark:bg-gray-800">
        <div class="container px-6 py-3 mx-auto md:flex">
            <div class="flex items-center justify-between">
                <div>
                    <a class="text-xl font-bold text-gray-800 dark:text-white md:text-2xl hover:text-gray-700 dark:hover:text-gray-300" href="#">Stenellie Joyce</a>
                </div>
